...
module.exports.postNewApplication=require('./DemandBLL').postNewApplication;
...
module.exports.getProvideByConditionNoDurationNoContent=require('./DemandBLL').getProvideByConditionNoDurationNoContent;
module.exports.getProvideByConditionNoContent=require('./DemandBLL').getProvideByConditionNoContent;
...
module.exports.applicateInVolunteerProvide = require('./ApplicationBLL').applicateInVolunteerProvide;
